...
<script setup>
	...
	onMounted(() => {
		...
		// For some reason, this component is messing with the scrolltrigger positions used in other places. To prevent this, refresh the ScrollTrigger after this component is mounted
		setTimeout(() => {
